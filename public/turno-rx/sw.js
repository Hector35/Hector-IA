// Pendientes v68 — evita reprocesar exactamente la misma fotografía en el turno activo.
...
const CACHE = 'pendientes-shell-20260818-4';
const SHELL = [
  '/turno-rx/',
  '/turno-rx/index.html',
  ...
  '/turno-rx/photo-dedupe-v68.js?v=68',
