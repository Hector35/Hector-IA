// Pendientes v80 — coherent shell cache; network-first for current assets/navigation.
...
const CACHE = 'pendientes-shell-20260819-80';
const SHELL = [
  '/turno-rx/',
  '/turno-rx/index.html',
  ...
  '/turno-rx/capture-fix-v80.js?v=80',
