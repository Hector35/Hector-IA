// Pendientes v76 — coherent shell cache; network-first for current assets/navigation.
...
const CACHE = 'pendientes-shell-20260819-76';
const SHELL = [
  '/turno-rx/',
  '/turno-rx/index.html',
  ...
  '/turno-rx/capture-fix-v76.js?v=76',
