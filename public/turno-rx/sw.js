// Pendientes v79 — coherent shell cache; network-first for current assets/navigation.
...
const CACHE = 'pendientes-shell-20260819-79';
const SHELL = [
  '/turno-rx/',
  '/turno-rx/index.html',
  ...
  '/turno-rx/capture-fix-v79.js?v=79',
