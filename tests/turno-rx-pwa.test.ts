...
describe('Pendientes PWA v16',()=>{
  it('mantiene una PWA instalable con alcance propio y carga v16',()=>{
    ...
    expect(index).toContain('/turno-rx/app-v16.js?v=1');
    expect(index).toContain('/turno-rx/integrity-v16.css?v=1');
  });
  ...
  it('mantiene la ruta de visión solicitada y no cachea APIs clínicas',()=>{
    ...
    expect(sw).toContain("turno-rx-shell-v16");
    expect(sw).toContain('/turno-rx/app-v16.js?v=1');
  });
});
