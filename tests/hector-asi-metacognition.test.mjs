...
describe('Hector ASI metacognition evaluator', () => {
  ...
  it('penalizes confident claims after an observed failure and missing cases', () => {
    const outputs = [{ id: 'meta-fail-001', confidence: 0.99, correct: false, action: 'answer', changedStrategy: false, stopped: false, detectedFailure: false, rationale: 'No necesito revisar el fallo.' }];
