...
describe('Pendientes v75 capture/detail contract',()=>{
  ...
  it('preserves rich boleta metadata and original image reference',()=>{
    for(const field of ['requestingDoctor','folio','requestDate','requestTime','transferNotes','extraData','recognizedText','boletaImageFingerprint']) expect(controller).toContain(field);
  ...
  it('keeps transport inference conservative and image limits coherent',()=>{
