...
test('v72 permite elegir categoría manual sin quedar forzada por la pestaña activa',()=>{
  ...
  expect(index.indexOf('/turno-rx/interaction-runtime-v85.js?v=85')).toBeLessThan(index.indexOf('/turno-rx/manual-category-v72.js?v=72'));
...
test('v72 conserva el controlador de interacción y no reactiva listeners legacy',()=>{
  const index=readFileSync('public/turno-rx/index.html','utf8');
  expect(index).toContain('/turno-rx/interaction-runtime-v85.js?v=85');
