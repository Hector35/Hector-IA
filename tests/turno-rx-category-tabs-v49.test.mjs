...
test('integra pestañas debajo de captura y conserva cola progresiva y gestos',()=>{
  expect(index).toMatch(/category-tabs-v49\.css\?v=1/);expect(index).toMatch(/app-v16\.js\?v=8/);
  expect(sw).toMatch(/turno-rx-shell-v54-tac-category-isolation/);expect(sw).toMatch(/category-tabs-v49\.css\?v=1/);
