...
import {installProgrammedDuplicateEnhancer} from './programmed-duplicate-ui';
...
import {installChatHistorySearchEnhancer} from './chat-history-search-ui';
import {installChatCopyEnhancer} from './chat-copy-ui';
import {installChatStopEnhancer} from './chat-stop-ui';
import {installChatJumpLatestEnhancer} from './chat-jump-latest-ui';
...
import './programmed-duplicate-ui.css';
import './one-command-ui.css';
import './composer-file-upload.css';
import './file-search-ui.css';
import './chat-history-search-ui.css';
import './chat-copy-ui.css';
import './chat-stop-ui.css';
import './chat-jump-latest-ui.css';
...
installChatHistorySearchEnhancer();
installChatCopyEnhancer();
installChatStopEnhancer();
installChatJumpLatestEnhancer();
