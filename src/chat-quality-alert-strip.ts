...
export function installChatQualityAlertStrip(){
 let composer:HTMLFormElement|undefined,strip:HTMLElement|undefined,confirmation:HTMLElement|undefined,timer:number|undefined,confirmationTimer:number|undefined;
