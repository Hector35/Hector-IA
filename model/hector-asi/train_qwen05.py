...
DEFAULT_TRAIN='model/hector-asi/data/smollm360-sft-v1.jsonl'
DEFAULT_VALIDATION='model/hector-asi/evals/smollm360-held-out-v1.jsonl'

def parse_args():
 p=argparse.ArgumentParser()
 p.add_argument('--output-dir',default='artifacts/hector-asi-qwen05-v1')
 p.add_argument('--train-file',default=DEFAULT_TRAIN)
 p.add_argument('--validation-file',default=DEFAULT_VALIDATION)
 p.add_argument('--experiment-id',default='hector-asi-qwen05-v1')
