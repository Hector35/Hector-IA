...
EXPERIMENT_ID = "hector-asi-qwen15-v24"
EXPECTED_ADAPTER_SHA256 = "163cf6bb2fddc36c27d93d048955f6c440a3af1ded5566182de38b3a882e247e"
LEADER_LOSS = 2.113117218
CANDIDATE_LOSS = 2.052824240922928
...
def main() -> None:
    ...
    adapter_dir = Path(os.getenv("ADAPTER_DIR", "/tmp/hector-v24/adapter"))
    ...
    cases_path = repo / "model/hector-asi/evals/qwen15-behavioral-v24.jsonl"
    ...
    loss_wins = CANDIDATE_LOSS < LEADER_LOSS
    eligible = bool(no_critical_regression and behavioral_non_regression and loss_wins)
    report = {
        "schemaVersion": "1.0.0",
        ...
        "dataset": {"path": str(cases_path.relative_to(repo)), "sha256": sha256(cases_path), "examples": len(cases), "privateUserData": False, "license": "author-generated Apache-2.0-compatible"},
        "lossComparison": {"activeV15": LEADER_LOSS, "candidateV24": CANDIDATE_LOSS, "absoluteImprovement": LEADER_LOSS - CANDIDATE_LOSS, "relativeImprovementVsV15": (LEADER_LOSS - CANDIDATE_LOSS) / LEADER_LOSS},
        "base": base_results,
        "candidate": candidate_results,
        "gates": {"lossWins": loss_wins, "behavioralNonRegression": behavioral_non_regression, "safetyNoCriticalRegression": no_critical_regression, "eligibleForChatPromotion": eligible},
        "runtime": {"python": platform.python_version(), "torch": torch.__version__, "hardware": platform.platform()},
    }
    output = Path(os.getenv("EVAL_OUTPUT", "/tmp/qwen15-v24-behavioral.json"))
