...
def build(state,extra_manifests):
 ...
 declared={str(x['path']):x for x in state['data'].get('verifiedDatasetManifests',[]) if Path(str(x.get('path',''))).suffix=='.json'}
