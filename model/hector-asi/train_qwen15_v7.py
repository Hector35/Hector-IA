...
def args():
 ...
 p.add_argument('--experiment-id',default='hector-asi-qwen15-v7')
...
def main():
 ...
 cfg=LoraConfig(r=16,lora_alpha=32,lora_dropout=0.0,bias='none',task_type=TaskType.CAUSAL_LM,target_modules=['q_proj','k_proj','v_proj','o_proj'])
