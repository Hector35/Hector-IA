...
const runtime:SelfModelRuntime={memories:12,workJobs:{total:8,completed:6,blocked:1},scheduledTasks:{total:3,active:2},activeSystemContexts:5,latestEvaluation:{score:92,grade:'A'}};
...
describe('buildSelfModel',()=>{
 ...
 it('vincula cada capacidad a componentes, evidencia y límite',()=>{
