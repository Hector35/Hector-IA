...
export const STAGE_SIX={
 ...
 targets:{
  ...
  pwaHumanApprovedExamples:INTELLIGENCE_STATE.pipeline.pwaHumanApproved.required,
...
export function stageSixStatus(env:Bindings){
 ...
 return{
  ...
  pipeline:[
   ...
   {id:'pwaFeedback',label:'Ejemplos PWA humanos verificados',observed:INTELLIGENCE_STATE.pipeline.pwaHumanApproved.observed,target:INTELLIGENCE_STATE.pipeline.pwaHumanApproved.required,open:INTELLIGENCE_STATE.pipeline.pwaHumanApproved.open,unit:'ejemplos'},
   {id:'autonomy',label:'Autonomía del modelo propio',target:STAGE_SIX.targets.ownModelAutonomyPercent,open:false,unit:'%'}
  ],
