...
export function buildPlan(prompt:string):AgentPlan{
 ...
 return{
  ...
  maxAttempts:3,
  phases:[
   {name:'inspect',goal:'Reunir estado, registro canónico y evidencia antes de actuar.',evidence:['fuentes','archivos o estado consultado','trabajo concurrente relevante']},
   {name:'plan',goal:'Dividir el objetivo en pasos observables sin duplicar superficies existentes.',evidence:['criterios de aceptación','riesgos y supuestos','propietario canónico de la UI/capacidad']},
   ...
   {name:'verify',goal:'Confirmar cada criterio con evidencia independiente y sin regresiones de gobernanza.',evidence:['resultado final','limitaciones pendientes','sin PWA duplicada']}
  ]
 };
}
