...
describe('metacognitive calibration',()=>{
 ...
 it('no escala con pocas muestras',()=>{expect(summarizeMetacognitiveCalibration([{predicted_confidence:.99,correct:0,route_tier:'fast',provider:'cloudflare'}]).preferDeep).toBe(false);});
