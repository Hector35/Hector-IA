...
function autonomyInstructions(mode:AutonomyMode){
 ...
 return 'Actúa como responsable de progreso continuo: revisa el estado más reciente, identifica el bloque pendiente de mayor valor, avanza lo máximo seguro, prueba, corrige y deja preparado el siguiente paso. Cambia de estrategia ante fallos repetidos y evita rehacer trabajo terminado.';
}
