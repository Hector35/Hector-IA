...
describe('chooseProvider',()=>{
 ...
 it('evita Cloudflare cuando el feedback personal demuestra baja utilidad',()=>{const decision=chooseProvider('hola','fast',false,true,health(),feedback({avoidCloudflare:true,reason:'feedback reciente indica baja utilidad de Workers AI'}));expect(decision.provider).toBe('openai');expect(decision.reason).toMatch(/aprendizaje controlado/);});
